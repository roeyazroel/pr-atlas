  ...
  return (
    <div className="app-shell" data-theme={resolvedTheme}>
      <header className="topbar">
        <div className="brand"><div className="brand-mark" aria-hidden="true"><GitPullRequest size={16} strokeWidth={2.4} /></div><span>PR Atlas</span><span className="beta">LOCAL MVP</span></div>
      ...
      <div className="workspace">
        ...
        <main className="content-pane">
          ...
          </> : <div className="empty-detail"><GitPullRequest size={24} /><h2>Select a pull request to open its walkthrough.</h2><p>This live repository has no open pull request selected.</p></div>}
        </main>
      </div>
    </div>
  );
